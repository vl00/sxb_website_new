...
namespace Sxb.School.Common.OtherAPIClient.Comment.Models
{
    public class GetQuestionByEIDRequest
    {
        /// <summary>
        /// 学部ID
        /// </summary>
        ...
        public string QueryString
        {
            get
            {
                var result = $"{nameof(EID)}={EID}";
                if (UserID.HasValue) result += $"&{nameof(UserID)}={UserID}";
                return result;
            }
        }
    }
    public class GetQuestionByEIDResponse
    {
        /// <summary>
        /// 序号
        /// </summary>
