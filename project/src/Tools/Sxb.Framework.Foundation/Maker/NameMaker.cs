...
namespace Sxb.Framework.Foundation.Maker
{
    ...
    public class NameMaker
    {
        ...
        public static List<string> GetNames(int count)
        {
            ...
            {
                int xing = new Random().Next(0, XingLen);
                int g = new Random().Next(0, 2);
                int ming;
                if (g == 1) //男
                {
                    ming = new Random().Next(0, ManNameLen);
                    Names.Add(Xing[xing] + _lastNameMan[ming]);
                }
                if (true)
                {
                    ming = new Random().Next(0, WoManNameLen);
                    Names.Add(Xing[xing] + _lastNameWoMan[ming]);
                }
            }
            return Names;
        }
        ...
        public static string GetName()
        {
            ...
            {
                ming = new Random().Next(0, ManNameLen);
                return Xing[xing] + _lastNameWoMan[ming];
            }
            if (true)
            {
                ming = new Random().Next(0, WoManNameLen);
